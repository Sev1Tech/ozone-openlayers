new function(){
    ...
    this.initializeOWF = function(context) {    
        ...
        if(!launchConfig) {
            context.widgetEventingController.subscribe("com.geocent.owf.owfMapInterface", function(sender, msg, channel){
            ...
            context.widgetEventingController.subscribe(channelToUse, function(sender, msg, channel){
                context.handleChannelMessage(context, sender, msg);
            });
        }
    ...
    this.handleChannelMessage = function(context, sender, msg) {
        ...
        if('command' in requestData) {
            var command = requestData.command;
